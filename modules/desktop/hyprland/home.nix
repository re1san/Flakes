...

{
  ...
  wayland.windowManager.hyprland = {
    ...
    extraConfig = ''
      ...
      bind = $mainMod SHIFT, Q, workspace,QQ
      ...
      bind=$mainMod CTRL,Q,exec,nvidia-offload icalingua-plus-plus --enable-features=UseOzonePlatform --ozone-platform=wayland
